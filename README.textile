...
A representer solution for Rails 3 inspired by Florian Hankes View Models for Rails 3 (http://florianhanke.com/view_models). For older versions of Rails please use versions up to 3. You may find view models useful (or not). Fact: They will keep code out of your views. Because view models do not like code in your view.
